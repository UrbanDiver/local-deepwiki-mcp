...
This file, `src/local_deepwiki/core/fuzzy_search.py`, provides utilities for fuzzy matching and search suggestions in a codebase. It is used to enhance search results by incorporating fuzzy string matching algorithms to [find](../generators/manifest.md) similar names and suggest corrections for queries. It integrates with the [`VectorStore`](vectorstore.md) to index and search function, class, and method names.

## Dependencies

This file imports:
- `fnmatch`, `re` for pattern matching
- `dataclasses` for `NameEntry`
- `pathlib.Path` for file path handling
- `typing.TYPE_CHECKING`, `Any` for type hints
- `rapidfuzz.fuzz`, `rapidfuzz.process` for fuzzy matching
- [`ChunkType`](../models.md), [`CodeChunk`](../models.md), [`SearchResult`](../models.md) from `local_deepwiki.models`
- [`VectorStore`](vectorstore.md) from `local_deepwiki.core.vectorstore`

## Integration

This file is used by:
- `FuzzySearchHelper` class, which is used by [`VectorStore`](vectorstore.md), `test_fuzzy_search`, and `test_vectorstore`
- Functions `fuzzy_score`, `fuzzy_match_name` are used by `test_fuzzy_search`
...
A helper class for building and using a fuzzy name index for search suggestions.

### Methods

#### `__init__(self, store: "VectorStore")`

Initialize the fuzzy search helper.

**Args:**
- `store`: The [VectorStore](vectorstore.md) instance to index names from.

#### `is_built(self) -> bool`

Check if the name index has been built.

#### `build_name_index(self) -> None`

Build an index of all function/class/method names for fuzzy matching.

This method iterates over all chunks in the vector store and extracts names for functions, classes, methods, and modules. The index is used for fast fuzzy matching and suggestion generation.

#### `find_similar_names(self, query: str, threshold: float = 0.6, limit: int = 5, chunk_type: ChunkType | None = None) -> list[tuple[str, float]]`
...
**Returns:**
- List of tuples of (name, score).

#### `generate_suggestions(self, query: str, results: list[SearchResult], threshold: float = 0.6, max_suggestions: int = 3) -> list[str]`

Generate 'Did you mean?' suggestions based on the query.

This method analyzes the query and current results to suggest alternative names that the user might have meant to search for.
...
#### `get_file_suggestions(self, query: str, threshold: float = 0.6, limit: int = 3) -> list[str]`
...
## `fuzzy_score(query: str, text: str) -> float`
...
## `fuzzy_match_name(query: str, name: str | None) -> float`
...
## `matches_path_pattern(file_path: str, pattern: str) -> bool`
...
## `rerank_with_fuzzy(results: list[SearchResult], query: str, fuzzy_weight: float = 0.3) -> list[SearchResult]`

Re-rank search results by combining vector similarity with fuzzy matching.

This improves search results by boosting results where the query matches the code name or content more precisely.
...
<details>
<summary>View Source (lines 280-293) | <a href="https://github.com/UrbanDiver/local-deepwiki-mcp/blob/[main](../export/pdf.md)/src/local_deepwiki/core/fuzzy_search.py#L280-L293">GitHub</a></summary>
...
<details>
<summary>View Source (lines 296-634) | <a href="https://github.com/UrbanDiver/local-deepwiki-mcp/blob/[main](../export/pdf.md)/src/local_deepwiki/core/fuzzy_search.py#L296-L634">GitHub</a></summary>

```python
class FuzzySearchHelper:
    # Methods: __init__, is_built, build_name_index, find_similar_names, generate_suggestions, get_file_suggestions, get_stats
```
...
|-----------|------|---------|-------------|
| `store` | `"VectorStore"` | - | The [VectorStore](vectorstore.md) instance to index names from. |


<details>
<summary>View Source (lines 317-327) | <a href="https://github.com/UrbanDiver/local-deepwiki-mcp/blob/[main](../export/pdf.md)/src/local_deepwiki/core/fuzzy_search.py#L317-L327">GitHub</a></summary>
...
<details>
<summary>View Source (lines 330-332) | <a href="https://github.com/UrbanDiver/local-deepwiki-mcp/blob/[main](../export/pdf.md)/src/local_deepwiki/core/fuzzy_search.py#L330-L332">GitHub</a></summary>
...
<details>
<summary>View Source (lines 334-413) | <a href="https://github.com/UrbanDiver/local-deepwiki-mcp/blob/[main](../export/pdf.md)/src/local_deepwiki/core/fuzzy_search.py#L334-L413">GitHub</a></summary>
...
<details>
<summary>View Source (lines 415-491) | <a href="https://github.com/UrbanDiver/local-deepwiki-mcp/blob/[main](../export/pdf.md)/src/local_deepwiki/core/fuzzy_search.py#L415-L491">GitHub</a></summary>
...
<details>
<summary>View Source (lines 493-562) | <a href="https://github.com/UrbanDiver/local-deepwiki-mcp/blob/[main](../export/pdf.md)/src/local_deepwiki/core/fuzzy_search.py#L493-L562">GitHub</a></summary>
...
<details>
<summary>View Source (lines 564-618) | <a href="https://github.com/UrbanDiver/local-deepwiki-mcp/blob/[main](../export/pdf.md)/src/local_deepwiki/core/fuzzy_search.py#L564-L618">GitHub</a></summary>
...
<details>
<summary>View Source (lines 620-634) | <a href="https://github.com/UrbanDiver/local-deepwiki-mcp/blob/[main](../export/pdf.md)/src/local_deepwiki/core/fuzzy_search.py#L620-L634">GitHub</a></summary>
...
<details>
<summary>View Source (lines 29-58) | <a href="https://github.com/UrbanDiver/local-deepwiki-mcp/blob/[main](../export/pdf.md)/src/local_deepwiki/core/fuzzy_search.py#L29-L58">GitHub</a></summary>
...
<details>
<summary>View Source (lines 61-106) | <a href="https://github.com/UrbanDiver/local-deepwiki-mcp/blob/[main](../export/pdf.md)/src/local_deepwiki/core/fuzzy_search.py#L61-L106">GitHub</a></summary>
...
<details>
<summary>View Source (lines 109-147) | <a href="https://github.com/UrbanDiver/local-deepwiki-mcp/blob/[main](../export/pdf.md)/src/local_deepwiki/core/fuzzy_search.py#L109-L147">GitHub</a></summary>
...
<details>
<summary>View Source (lines 150-209) | <a href="https://github.com/UrbanDiver/local-deepwiki-mcp/blob/[main](../export/pdf.md)/src/local_deepwiki/core/fuzzy_search.py#L150-L209">GitHub</a></summary>
...
<details>
<summary>View Source (lines 212-257) | <a href="https://github.com/UrbanDiver/local-deepwiki-mcp/blob/[main](../export/pdf.md)/src/local_deepwiki/core/fuzzy_search.py#L212-L257">GitHub</a></summary>
...
<details>
<summary>View Source (lines 260-276) | <a href="https://github.com/UrbanDiver/local-deepwiki-mcp/blob/[main](../export/pdf.md)/src/local_deepwiki/core/fuzzy_search.py#L260-L276">GitHub</a></summary>
...
<details>
<summary>View Source (lines 637-655) | <a href="https://github.com/UrbanDiver/local-deepwiki-mcp/blob/[main](../export/pdf.md)/src/local_deepwiki/core/fuzzy_search.py#L637-L655">GitHub</a></summary>
...
flowchart TD
    N0[ChunkType]
    N1[FuzzySearchHelper.build_nam...]
    N2[FuzzySearchHelper.find_simi...]
    N3[FuzzySearchHelper.generate_...]
    N4[FuzzySearchHelper.get_file_...]
    N5[NameEntry]
    N6[Path]
    N7[SearchResult]
    N8[_get_table]
    ...
    N10[extract]
    N11[filter_by_path]
    N12[find_similar_names]
    N13[fnmatch]
    N14[fuzzy_match_name]
    N15[fuzzy_score]
    N16[iterrows]
    N17[match]
    N18[matches_path_pattern]
    N19[partial_ratio]
    N20[rerank_with_fuzzy]
    N21[sort]
    N22[to_pandas]
    N23[token_set_ratio]
    N15 --> N23
...
- **[`ChunkType`](../models.md)**: called by `FuzzySearchHelper.build_name_index`
- **`NameEntry`**: called by `FuzzySearchHelper.build_name_index`
- **`Path`**: called by `FuzzySearchHelper.get_file_suggestions`
- **[`SearchResult`](../models.md)**: called by `rerank_with_fuzzy`
- **`_get_table`**: called by `FuzzySearchHelper.build_name_index`
- **`add`**: called by `FuzzySearchHelper.find_similar_names`, `FuzzySearchHelper.generate_suggestions`, `FuzzySearchHelper.get_file_suggestions`
- **`extract`**: called by `FuzzySearchHelper.find_similar_names`, `FuzzySearchHelper.get_file_suggestions`
- **`find_similar_names`**: called by `FuzzySearchHelper.generate_suggestions`
...
- **`iterrows`**: called by `FuzzySearchHelper.build_name_index`
- **`match`**: called by `matches_path_pattern`
- **`matches_path_pattern`**: called by `filter_by_path`
- **`partial_ratio`**: called by `fuzzy_score`
- **`sort`**: called by `FuzzySearchHelper.generate_suggestions`, `rerank_with_fuzzy`
...
|--------|------|--------|------|--------|
| `NameEntry` | class | Brian Breidenbach | 1 week ago | `dc57a7b` Add low-priority enhancemen... |
| `FuzzySearchHelper` | class | Brian Breidenbach | 1 week ago | `dc57a7b` Add low-priority enhancemen... |
| `__init__` | method | Brian Breidenbach | 1 week ago | `dc57a7b` Add low-priority enhancemen... |
| `is_built` | method | Brian Breidenbach | 1 week ago | `dc57a7b` Add low-priority enhancemen... |
| `build_name_index` | method | Brian Breidenbach | 1 week ago | `dc57a7b` Add low-priority enhancemen... |
| `find_similar_names` | method | Brian Breidenbach | 1 week ago | `dc57a7b` Add low-priority enhancemen... |
| `generate_suggestions` | method | Brian Breidenbach | 1 week ago | `dc57a7b` Add low-priority enhancemen... |
| `get_file_suggestions` | method | Brian Breidenbach | 1 week ago | `dc57a7b` Add low-priority enhancemen... |
| `get_stats` | method | Brian Breidenbach | 1 week ago | `dc57a7b` Add low-priority enhancemen... |
| `should_auto_enable_fuzzy` | function | Brian Breidenbach | 1 week ago | `dc57a7b` Add low-priority enhancemen... |
| `fuzzy_score` | function | Brian Breidenbach | 1 week ago | `fa2feb8` Add CLI progress bars and f... |
| `fuzzy_match_name` | function | Brian Breidenbach | 1 week ago | `fa2feb8` Add CLI progress bars and f... |
| `matches_path_pattern` | function | Brian Breidenbach | 1 week ago | `fa2feb8` Add CLI progress bars and f... |
| `rerank_with_fuzzy` | function | Brian Breidenbach | 1 week ago | `fa2feb8` Add CLI progress bars and f... |
| `extract_highlights` | function | Brian Breidenbach | 1 week ago | `fa2feb8` Add CLI progress bars and f... |
| `filter_by_path` | function | Brian Breidenbach | 1 week ago | `fa2feb8` Add CLI progress bars and f... |

## Relevant Source Files

- `src/local_deepwiki/core/fuzzy_search.py:280-293`
