...
# Common names to exclude from cross-linking to avoid false positives.
# Covers Python builtins, generic short names, common method names, and generic callables.
_EXCLUDED_CROSSLINK_NAMES: frozenset[str] = frozenset(
    {
