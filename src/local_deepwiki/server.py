...
TOOL_HANDLERS: dict[str, ToolHandler] = {
    ...
    "get_architecture_trends": handle_get_architecture_trends,
    "get_churn_metrics": handle_get_churn_metrics,
    "get_co_change": handle_get_co_change,
    "get_cohesion_metrics": handle_get_cohesion_metrics,
    "get_duplication_metrics": handle_get_duplication_metrics,
    "get_maintainability_metrics": handle_get_maintainability_metrics,
    "get_testability_metrics": handle_get_testability_metrics,
    "get_guided_tour": handle_get_guided_tour,
    ...
    "get_onboarding_guide": handle_get_onboarding_guide,
