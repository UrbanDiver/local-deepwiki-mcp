"""Tests for codemap args validation, data structures, handlers, and tool registration.
...
See also:
- test_codemap_entry_points.py: discover_entry_points, suggest_topics
- test_codemap_graph.py: build_cross_file_graph, min_similarity floor
- test_codemap_viz.py: generate_codemap_diagram, narrative, data flow edges
"""
